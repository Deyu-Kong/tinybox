...
> task/exec 与 environment model 已在 2026-08-22 完成 M0/M1 root 验收；Agent
> CLI 与 adapter 尚未实现，因此仍不能称为完整 Agent container MVP。save/restore/reset 仅是 MVP 后的独立可选评估，不参与
