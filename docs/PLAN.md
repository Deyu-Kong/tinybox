...
> task/exec、environment model 与 Agent CLI 已在 2026-08-22 完成 M0–M2 root
> 验收；Agent adapters 尚未实现，因此仍不能称为完整 Agent container MVP。save/restore/reset 仅是 MVP 后的独立可选评估，不参与
