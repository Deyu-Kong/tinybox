...
install -d "$prefix/bin" "$prefix/share/tinybox/adapters/opencode" "$prefix/share/tinybox/adapters/pi"
...
install -m 0644 adapters/opencode/bash.ts adapters/opencode/runtime.js \
    "$prefix/share/tinybox/adapters/opencode/"
